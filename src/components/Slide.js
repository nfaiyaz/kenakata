...
const Slide = ({ img, title, mainTitle, price }) => {
    return (
        <div className="outline-none border-none relative">
            <div className="absolute left-7.5 md:left[70px] max-w-62.5 sm:max-w-87.5 top-[50%] -translate-y-[50%] space-y-2 lg:space-y-4 bg-[#ffffffa2] sm:bg-transparent p-4 sm:p-0 rounded-lg sm:rounded-none">
            ...
            <Image className="w-full h-75 md:h-auto rounded-xl object-cover object-right md:object-bottom-left" src={img} alt="banner" width={2000} height={900}/>
        </div>
    );
}
